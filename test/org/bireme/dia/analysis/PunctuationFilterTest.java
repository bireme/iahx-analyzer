...
public class PunctuationFilterTest {
    ...
    public PunctuationFilterTest() {
    }
    
    /**
     * Test of incrementToken method, of class PunctuationFilter.
    ...
    public void testIncrementToken() throws IOException {
        ...
        final TokenFilter instance1 = new PunctuationFilter(source1);
        ...
        final TokenFilter instance2 = new PunctuationFilter(source2);
