...
class DeCSAuthorizedTermAndCategoryAnalyzer(indexPath: String) extends Analyzer:
  private val getDescriptor: Boolean = true  // If true it will include the descriptor field in the generated tokens
  private val getQualifiers: Boolean = false // If true it will include the qualifiers field in the generated tokens
  private val getJoinDescrQual: Boolean = false // If true it will include descriptor/qualifier and descriptor/abbreviation in the generated tokens
  private val getSynonyms: Boolean = false   // If true it will include the synonyms field in the generated tokens
  ...
  override def toString: String =
    "class: org.bireme.dia.analysis.DeCSAuthorizedTermAndCategoryAnalyzer" +
      "\nparameters:" +
